package com.example.myrecipe.view.activities
...
import com.example.myrecipe.databinding.ActivityAddUpdateDishBinding
import com.example.myrecipe.databinding.DialogCustomImageSelectionBinding
import com.example.myrecipe.databinding.DialogCustomListBinding
...
import com.example.myrecipe.view.adapters.CustomListItemAdapter
...
class AddUpdateDishActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private val mMyRecipeViewModel : MyRecipeViewModel by viewModels {
        MyRecipeViewModelFactory((application as MyRecipeApplication).repository)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupActionBar()
        //removes underline from editText
        mBinding.etTitle.setBackgroundResource(android.R.color.transparent)
        mBinding.etType.setBackgroundResource(android.R.color.transparent)
        mBinding.etCategory.setBackgroundResource(android.R.color.transparent)
        mBinding.etIngredients.setBackgroundResource(android.R.color.transparent)
        mBinding.etCookingTime.setBackgroundResource(android.R.color.transparent)
        mBinding.etRecipe.setBackgroundResource(android.R.color.transparent)
        ...
        if (v != null) {
            when(v.id) {
                ...
                R.id.btn_add_dish -> {
                    ...
                    val recipe = mBinding.etRecipe.text.toString().trim { it <= ' ' }
                    ...
                    when {
                        ...
                        TextUtils.isEmpty(recipe) -> {
                            ...
                            //when the dish is valid
                            val myRecipeDetails: MyRecipe = MyRecipe(
                                mImagePath,
                            ...
                            mMyRecipeViewModel.insert(myRecipeDetails)
                            Toast.makeText(
                                this@AddUpdateDishActivity,
                                "Recipe added successfully",
                                Toast.LENGTH_SHORT
                            ).show()
                            Log.e("Insetion", "Success")
                            finish()
                        }
                    }
                }
        ...
        binding.tvGallery.setOnClickListener {
            Dexter.withContext(this).withPermission(
                ...
                override fun onPermissionDenied(p0: PermissionDeniedResponse?) {
                    Toast.makeText(
                            this@AddUpdateDishActivity,
                            "You have denied the Gallery permission to select image",
                            Toast.LENGTH_SHORT
                    ).show()
                }
    ...
    private fun customItemListDialog(title:String, itemList: List<String>, selection: String) {
        ...
        mCustomListDialog.window?.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))
